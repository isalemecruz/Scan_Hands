...
// Busca dados do usuário + turma vinculada
$stmt = $conn->prepare("
    SELECT u.nome, u.telefone, u.senha, u.foto_perfil, t.nome AS turma_nome
    FROM usuario u
...
if ($result->num_rows > 0) {
    ...
    $turma = $dados['turma_nome'] ?? 'Sem turma';
...
<div class="container">
    ...
    <h2 class="title" style="color: #3d68b2">Dados Pessoais</h2>
