...
$sql = "SELECT nome, email, cpf, telefone FROM usuario WHERE tipo = 'professor'";
...
<div class="main">
  <div class="card-container">
    <div class="header-buttons">
      <button class="btn btn-outline-secondary">⚙️ Filtrar Professor </button>
            ...
            <tr>
              ...
              <td style="position: relative;">
                ...
                <div class="options-card">
                  ...
                  <a href="excluirProfessor.php?cpf=<?php echo urlencode($row["cpf"]); ?>">Excluir professor</a>
                  <a href="alterarProfessor.php?cpf=<?php echo urlencode($row["cpf"]); ?>">Alterar professor</a>
                </div>
              </td>
            </tr>
          <?php endwhile; ?>
