...
$nome = $telefone = $senhaUsuario = '';
$fotoBase64 = '';

// Busca dados da secretaria
$stmt = $conn->prepare("
    SELECT nome, telefone, senha, foto_perfil
    FROM usuario
    WHERE email = ? AND tipo = 'secretaria'
");
...
<head>
    ...
    <title>Perfil da Secretaria</title>
